...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice teamwork and skills for competitive soccer matches",
    ...
    "Basketball Club": {
        ...
        "max_participants": 15,
        "participants": ["jordan@mergington.edu", "avery@mergington.edu"]
    },
    "Drama Club": {
    ...
    "Art Workshop": {
        ...
        "max_participants": 16,
        "participants": ["grace@mergington.edu", "nora@mergington.edu"]
    },
    "Math Olympiad": {
    ...
    "Science Club": {
        "description": "Conduct experiments and explore science concepts in depth",
